            ...
            <div class="top-bar">
                <div class="top-bar-inner">
                    <ul class="social-list list-inline mx-auto">
                        ...
                        <li class="list-inline-item me-0 me-md-1 me-lg-2">
                            <a href="./assets/Schapink-CV-Resume-FR-EN.pdf" download="Schapink-CV-Resume-FR-EN.pdf" data-toggle="tooltip" data-placement="bottom" title="Télécharger le CV" data-delay="{ "show": 0, "hide": 0 }"><i class="bi bi-arrow-down-circle"></i></a>
                        </li>
                    </ul><!--//social-list-->
